...
// composer mockup). For free / trial users this IS the upgrade flow:
...
// Check icon for the selected plan-card radio.
...
// Free / Pro comparison rows — match real app caps so this isn't
// aspirational. (3 captures/day for free; multi-cal is Pro since
// 1013 ships that surface area.)
const COMPARE_ROWS = [
...
export default function ManageSubscriptionScreen() {
  ...
  // Savings % drives the "Save N%" badge on the Yearly card.
    ...
    <View style={{ flex: 1, backgroundColor: C.void }}>
      ...
      <SafeAreaView style={{ flex: 1 }} edges={['top']}>
        ...
        >
          ...
          {/* ── "What Pro adds" eyebrow + table — hidden for active subscribers */}
