...
- No audio recordings: voice capture is transcribed to text by your device's built-in speech recognition. The audio never reaches our servers.
- No location data. No contacts. No health records.
...
- **Export**: you can export your data from Profile → Account & settings.
- **Delete**: Profile → Delete account permanently removes your account and all synced data from our servers. Local data is wiped from the device on sign-out.
- **AI**: the app remains fully functional if you never touch an AI feature.
