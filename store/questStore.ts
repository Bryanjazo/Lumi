...
export interface Quest {
   ...
   *
   * DEVICE-LOCAL for now: lib/sync.ts's push/pull row mapping does NOT
   * include this field, so it never round-trips to the cloud or other
   * devices. That's acceptable — the step is cheap to regenerate, and
   * syncing it would need a schema column we're not adding pre-launch.
   */
